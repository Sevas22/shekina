...
export const metadata: Metadata = {
  title: `Mujer | Tienda ${SITE_NAME}`,
  description:
    "Colección mujer: billeteras, bolsos y accesorios en cuero. Consulta por WhatsApp.",
}
...
export default async function TiendaMujerPage({ searchParams }: Props) {
      ...
      <div className="pt-24 pb-20 bg-secondary/30">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <nav className="mb-8 font-[var(--font-inter)] text-sm text-muted-foreground flex flex-wrap gap-x-2 gap-y-1 items-center">
            ...
            <span className="text-foreground">Mujer</span>
          </nav>
          ...
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto font-[var(--font-inter)]">
              Piezas pensadas para vos. Filtrá por tipo de producto y abrí cada ficha para
